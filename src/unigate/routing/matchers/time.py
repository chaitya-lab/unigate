...
class HourOfDayMatcher(RoutingMatcher):
    """Match based on hour of day."""
...
class TimeRangeMatcher(RoutingMatcher):
    """Match based on time range (HH:MM-HH:MM)."""
